...
@section('content')
    <section>
        ...
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> {{__('Form for adding Roles')}}</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="box box-outlined">
                        ...
                        <div class="box-body no-padding">
                            {!! Form::open(array('method' => 'POST', 'url' => 'admin/roles', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                            @include('admin.forms.roles', ['submit' => 'Add'])
                            {!! Form::close() !!}
