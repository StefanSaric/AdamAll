...
@section('content')
    <section>
        <ol class="breadcrumb">
            ...
            <li class="active">{{__('Edit Commercials')}}</li>
        </ol>
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> {{__('Form for editing Commercials')}}</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="box box-outlined">
                        ...
                        <div class="box-body no-padding">
                            {!! Form::model($commercials, array('method' => 'PATCH', 'url' => 'admin/commercials/'.$commercials->id, 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'novalidate' => 'novalidate', 'files' => true)) !!}
                            @include('admin.forms.commercials', ['submit' => 'Edit'])
                            {!! Form::close() !!}
...
@section('pageScripts')
    ...
    <script src="{{ asset('assets/js/admin/commercials.image.js') }}"></script>
@stop
