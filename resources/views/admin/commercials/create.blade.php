...
@section('content')
    <section>
        <ol class="breadcrumb">
            ...
            <li class="active">Dodaj Reklamu</li>
        </ol>
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Forma za dodavanje Reklama</h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="box box-outlined">
                        <div class="box-head">
                            <header><h4 class="text-light">Dodaj Reklamu:</h4></header>
                        </div>
                        <div class="box-body no-padding">
                            {!! Form::open(array('method' => 'POST', 'url' => 'admin/commercials', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                            @include('admin.forms.commercials', ['submit' => 'Dodaj'])
                            {!! Form::close() !!}
